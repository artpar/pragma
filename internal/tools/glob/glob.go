...
- When you are doing an open ended search that may require multiple rounds, use an available delegation or research capability instead
- If no files match, try broader patterns: widen from a specific directory to **, try alternative extensions, or use an available content-search capability instead of filenames

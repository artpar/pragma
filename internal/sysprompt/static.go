...
const doingTasksText = `# Doing tasks
 ...
 - Prefer the structured patch editing capability for multi-line or multi-file code edits when it is available. Use smaller exact-replacement edits for narrow changes, and use full-file writes only for new files or complete rewrites when that is clearly justified.

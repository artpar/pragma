...
// noToolsPreamble prevents the compaction model from calling tools.
...
// noToolsTrailer is a reminder at the end of the compaction prompt.
const noToolsTrailer = `

REMINDER: Do NOT call any tools. Respond with plain text only — an <analysis> block followed by a <summary> block. Tool calls will be rejected and you will fail the task.`

// baseCompactPrompt is the 9-section compaction prompt.
// Ported verbatim from TS: /Users/artpar/Downloads/src/services/compact/prompt.ts
...
// FormatCompactSummary strips the <analysis> drafting scratchpad and extracts
// the <summary> content. The analysis block improves summary quality but has
...
// CompactUserMessage wraps a formatted summary in the continuation context
...
// CompactSystemPrompt is the system prompt used for the compaction LLM call.
const CompactSystemPrompt = "You are a helpful AI assistant tasked with summarizing conversations. Produce a thorough, detailed summary that preserves all technical context needed to continue development work."

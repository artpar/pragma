...
// translating between internal model types and OpenAI's wire format.
package openai
...
// wireMessage represents a message in the OpenAI API.
...
// wireErrorResponse is the OpenAI API error envelope.
